...
export const Users = () => {
  ...
  const usersPerDepartment = {
    ...
    fills: ['#fb8281', '#5f6b6d', '#4bc5bc', '#dfbfbf', '#3699b8', '#8bd4eb', '#5f6b6d', '#5f6b6d', '#fd625e', '#374649']
  };
        ...
        <div style={{display: 'grid', gridTemplateColumns: '50% 50%', height: '40vh'}}>
          <div>
            <Block title="Users per Type">
              <Pie data={usersPerType.data} fills={usersPerType.fills} />
            </Block>
          </div>
          <div>
            <Block title="Users per Department">
              <Pie data={usersPerDepartment.data} fills={usersPerDepartment.fills} />
            </Block>
          </div>
          <div>
            <Block title="Users per Type">
